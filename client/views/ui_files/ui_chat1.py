...
################################################################################
## Form generated from reading UI file 'chat1.ui'
##
...
"}")
        icon = QIcon()
        icon.addFile(u"../../../../../Downloads/pys2-tcp-chat-master/pys2-tcp-chat-master/client/assets/icons8-exit-200.png", QSize(), QIcon.Normal, QIcon.Off)
